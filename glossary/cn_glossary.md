...
| Percentages ("18%", "10–15%") | Write the "%" glyph out as **百分之** — e.g. 18% → 百分之十八, 10%到15% → 百分之十到百分之十五. The ElevenLabs voice mispronounces the "%" symbol (confirmed by Wayne on `what-makes-muscles-grow_2026-4-11`, 2026-07-22). Costs syllables/density, so in tight native-mode windows tighten the surrounding wording to absorb it. Applies to the zh dub script AND any zh subtitle text spoken aloud. |
